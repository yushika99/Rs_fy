...
public class HistortyExActivity extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todayItemsAdapter = new TodayItemsAdapter(HistortyExActivity.this, myDataList);
    ...
    public void onDateSet(DatePicker datePicker, int year, int month, int dayOfMonth) {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(HistortyExActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
